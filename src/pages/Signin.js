    ...
    return(
        <div className="bg-black min-h-screen flex items-center justify-center p-4">
             ...
             <div className="flex flex-col md:flex-row w-full md:w-[95%] min-h-screen md:h-auto overflow-hidden rounded-3xl">
               ...
               <div className="flex flex-col md:items-start w-full md:w-1/2 bg-[00000] text-white p-8 pt-36">
                 <h1 className="text-white text-3xl font-bold mb-12 md:mb-24">Sign In</h1>
                 <LogIn />
               </div>
